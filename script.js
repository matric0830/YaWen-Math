...
const CHAPTERS = {
  ...
  book2: [
    ...
    { title: "第四章 三角比的性質與應用", lessons: [
      topic("048", "銳角三角比的定義", { href: "lessons/book2/trig-ratio-quiz/index.html", status: "practice", tags: ["以斜邊表示兩股"] }), topic("049", "廣義角三角比的定義"), topic("050", "三角函數與單位圓"),
...
topic("058", "弧度量", { href: "lessons/book3/radian/index.html", status: "practice", tags: ["函數值閃卡", "函數值測驗"] }), topic("059", "扇形的周長與面積"), topic("060", "三角函數的圖形"),
      topic("061", "三角函數的週期與伸縮平移"),
      { ...topic("062", "和差角公式、二倍角公式與半角公式", { href: "lessons/book3/trigonometry-formula-puzzle/index.html", status: "practice", tags: ["閃卡", "公式拼圖", "測驗"] }), number: "主題062～064" },
      topic("065", "正餘弦疊合")
    ]},
